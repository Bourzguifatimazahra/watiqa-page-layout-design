    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-blue-100">Votre assistant universitaire personnel</p>
          <p className="text-sm text-blue-200 mt-1">Gérez facilement tous vos documents et informations académiques</p>
        </div>
      </div>
      ...
      <div className="px-6 py-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Services Principaux</h2>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Votre carte étudiante a été approuvée</p>
                  </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Mise à jour de votre dossier d'inscription</p>
                  </div>
